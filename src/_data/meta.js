...
export const siteName = 'YarnLab';
export const siteDescription = 'A drop-in space for yarn and fiber-crafts';
...
export const author = {
  name: 'Quinn Daedal', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
};
// for the site developer, used for footer credits and humans.txt info
export const creator = {
  name: 'Quinn Daedal', // i.e. Lene Saile - creator's (developer) name.
  email: 'qad@stanford.edu',
  website: 'https://quinndaedal.com/',
  social: 'https://bsky.app/profile/quinnanya.me'
};
...
export const blog = {
  // RSS feed
  name: 'YarnLab News',
  description: 'News and updates from YarnLab',
